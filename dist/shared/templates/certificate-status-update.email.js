...
exports.CertificateStatusUpdateEmailTemplate = void 0;
const enums_1 = require("../../certificate/enums");
const CertificateStatusUpdateEmailTemplate = (applicant, status, msg, webUrl) => {
    const message = `Hello ${applicant.name} Team,
    ${[enums_1.ECertificateStatus.GRANTED].includes(status)
        ? 'We are pleased to inform you'
        : 'We are sorry to inform you'} that your DBI Trust Seal Certificate ${msg}`;
    const template = `
  <!DOCTYPE html>
  <html>
   <head>
...
exports.CertificateStatusUpdateEmailTemplate = CertificateStatusUpdateEmailTemplate;
//# sourceMappingURL=certificate-status-update.email.js.map