...
exports.ConfirmationEmailTemplate = void 0;
const ConfirmationEmailTemplate = (username, password, webUrl) => {
    const message = `Welcome to the Trust seal network,<b> <font color="#0c5ab6";>${username},</font></b><br>
    We are sending you this email to confirm that your account has been set successfully; Please use this password <font size="10px">${password}</font> to log into your account by clicking on the button below.</b><br>
    ...
    <tr >
     ...
     <tr>
      <td style="text-align: left;">
       <b><span style="color: #000000; font-family: sans-serif; font-size: 32px; ">Account confirmation</b>
      </td>
     </tr>
     <tr>
